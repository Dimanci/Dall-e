  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#222328] text-[32px]'>
          ...
          <p className='mt-2 text-[#777e75] text-[16px] max-w[500px]'>
            Build visually stunning images with the help of DALL-E AI and show them to your friends
          </p>
        </h1>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#777e75] text-[14px]'>You can share this creation with your friends if you would like so</p>
          <button type='submit'
